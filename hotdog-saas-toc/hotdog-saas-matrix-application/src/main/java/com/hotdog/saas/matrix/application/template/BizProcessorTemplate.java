package com.hotdog.saas.matrix.application.template;

import com.hotdog.saas.matrix.application.entity.request.BaseRequestParam;
import com.hotdog.saas.matrix.application.entity.request.PageRequestParam;
import com.hotdog.saas.matrix.application.entity.response.BaseResponse;
import com.hotdog.saas.matrix.domain.page.PageRequest;
