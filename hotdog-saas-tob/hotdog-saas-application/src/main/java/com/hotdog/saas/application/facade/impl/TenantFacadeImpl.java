...
import com.hotdog.saas.application.processor.tenant.TenantOptionsProcessor;
...
public class TenantFacadeImpl extends BaseProcessor implements TenantFacade {
    ...
    private final TenantOptionsProcessor tenantOptionsProcessor;
    ...
    public TenantFacadeImpl(TenantCreateProcessor tenantCreateProcessor, TenantListProcessor tenantListProcessor, TenantOptionsProcessor tenantOptionsProcessor, TenantDetailProcessor tenantDetailProcessor, TenantUpdateProcessor tenantUpdateProcessor, TenantDeleteProcessor tenantDeleteProcessor) {
        this.tenantCreateProcessor = tenantCreateProcessor;
        this.tenantListProcessor = tenantListProcessor;
        this.tenantOptionsProcessor = tenantOptionsProcessor;
    ...
    @Override
    public BaseResponse<List<TenantOptionsDTO>> tenantOptions(TenantOptionsRequest tenantOptionsRequest) {
        return this.doBiz(tenantOptionsRequest, tenantOptionsProcessor);
    }
