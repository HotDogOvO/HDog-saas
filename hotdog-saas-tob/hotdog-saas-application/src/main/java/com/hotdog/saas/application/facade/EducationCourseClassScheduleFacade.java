...
public interface EducationCourseClassScheduleFacade {
    ...
    BaseResponse<List<EducationCourseClassScheduleOptionsDTO>> educationCourseClassScheduleOptions(EducationCourseClassScheduleOptionsRequest educationCourseClassScheduleOptionsRequest);
