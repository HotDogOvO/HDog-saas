...
public class TenantFacadeImpl extends BaseProcess implements TenantFacade {
    ...
    public TenantFacadeImpl(TenantCreateProcess tenantCreateProcess, TenantListProcess tenantListProcess, TenantUpdateProcess tenantUpdateProcess, TenantDeleteProcess tenantDeleteProcess) {
