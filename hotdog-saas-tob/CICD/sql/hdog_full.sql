...
(
    ...
    `type`           tinyint                                                       NOT NULL COMMENT '人员类型（1：教师 2：学员）',
    ...
    PRIMARY KEY (`id`),
    KEY              `idx_class_no` (`class_no`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='课程班级人员表';
...
(
    ...
    PRIMARY KEY (`id`),
    KEY                `idx_class_no` (`class_no`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='课程授课记录表';
...
(
    ...
    PRIMARY KEY (`id`),
    KEY                `idx_class_no` (`class_no`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='班级课程表';
...
(
    ...
    `create_time`     datetime                                                      NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Kafka死信队列表';
